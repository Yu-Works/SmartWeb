...
import com.IceCreamQAQ.Yu.loader.compiler.InvokerCompiler
...
//    private val vds: Array<ValidateData>
    ...
    fun spawnClassValidator(clazz: Class<*>): Class<out ClassValidatorBase> {
        ...
        val classBuilder = StringBuilder("package impl.icecreamqaq.yu.v.ci.spawnImpl;\n" +
                "\n" +
        ...
        val validateBuilder = StringBuilder("    @Override\n" +
...
//            if (field.is)
            ...
            else if ((field.type == Boolean::class.java || field.type == Boolean::class.javaObjectType) && clazz.haveMethod("is$ff")) "is$ff()"
